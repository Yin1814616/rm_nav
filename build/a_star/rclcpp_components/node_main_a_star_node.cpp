...
#define NODE_MAIN_LOGGER_NAME "a_star_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liba_star.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<global_planner::aStar>";
